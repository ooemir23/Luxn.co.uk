...
function BookingScreen({ t, lang, category, id, go }) {
  ...
  const fee = Math.round(item.price * 0.04);
            ...
            <div className="fade-in">
              ...
              <div className="form-grid">
                ...
                <div className="form-row">
                  ...
                  <input className="text-input" defaultValue="14 Jun 2026" />
                </div>
                <div className="form-row">
                  <span className="form-label">{t.detail.check_out}</span>
                  <input className="text-input" defaultValue="21 Jun 2026" />
                </div>
                <div className="form-row">
                  <span className="form-label">{t.search.guests}</span>
                  <select className="text-input" defaultValue="2">
        ...
        {step < 3 ? (
          <aside className="book-card">
            ...
            <div className="book-row">
              <span>{item.currency}{item.price.toLocaleString()} × {nights} {category === "sail" ? (lang === "tr" ? "hafta" : "weeks") : category === "drive" ? (lang === "tr" ? "gün" : "days") : (lang === "tr" ? "gece" : "nights")}</span>
              <span>{item.currency}{subtotal.toLocaleString()}</span>
            </div>
            <div className="book-row">
              <span>{lang === "tr" ? "Concierge ücreti" : "Concierge fee"}</span>
              <span>{item.currency}{fee.toLocaleString()}</span>
            </div>
            <div className="book-row total">
              <span>{t.detail.total}</span>
              <span className="price">{item.currency}{total.toLocaleString()}</span>
            </div>
