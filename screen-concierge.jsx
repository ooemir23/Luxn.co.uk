...
function ConciergeScreen({ t, lang, go }) {
  ...
  const quickReplies = lang === "tr" ? [
    ...
    { label: "Bali'de villa öner", type: "stay", id: "s5" },
    ...
    { label: "Suggest a Bali villa", type: "stay", id: "s5" },
  ...
  const triggerAgentReply = (userMsg) => {
    ...
    setTimeout(() => {
      ...
      } else if (lower.includes("bali") || lower.includes("s5") || lower.includes("villa")) {
        replyText = lang === "tr"
          ? "Bali için Bujang Senja villasını şiddetle tavsiye ederim. Uçurum kenarındaki konumuyla Hint Okyanusu'na bakan panoramik manzarası ve özel havuzu ile unutulmaz bir kaçış vadediyor."
          : "For Bali, I highly recommend Bujang Senja. Perched on a cliff with panoramic Indian Ocean views and a private pool, it promises an unforgettable escape.";
        recommendedItem = (window.STAYS || []).find(s => s.id === "s5");
        recommendedCat = "stay";
